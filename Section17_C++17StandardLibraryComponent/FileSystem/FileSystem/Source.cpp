...
void UsingPath() {
	fs::path selectedPath{ R"(C:\Users\User\Downloads\Test.txt)" };
...
int main() {
	//UsingPath();
	//TraversingDirectory(R"(C:\Users\User\Downloads)") ;
	//DirectoryOperations(R"(C:\Users\User\Downloads\)") ;
	Permissions(R"(C:\Users\User\Downloads\Test.txt)");
}
